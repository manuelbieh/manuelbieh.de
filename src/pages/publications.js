                ...
                <Grid>
                    ...
                    <Row className={css.publication}>
                        ...
                        <Column xs={12} md={8} lg={9} xl={10}>
                            ...
                            <p>
                                Mobiles Internet ist Realität. Jeder, der Websites betreibt,
                                gestaltet, konzipiert oder entwickelt, muss sich mit dem Thema
                                auseinandersetzen. Dabei geht es natürlich zunächst um die Fragen,
                                wann ein mobiler Auftritt sinnvoll ist, welcher Content ausgewählt
                                und wie der Auftritt schließlich konzipiert werden soll.
                            </p>
                            <p>
                                <strong>
                    ...
                    <Row className={css.publication}>
                        ...
                        <Column xs={12} md={8} lg={9} xl={10}>
                            <h3>
                                Mobile Möglichkeiten – Tools für die Entwicklung mobiler Webseiten
                            </h3>
